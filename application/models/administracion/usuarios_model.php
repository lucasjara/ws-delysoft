...
class Usuarios_model extends CI_Model
{
    ...
    {
        $this->db->select("local.NOMBRE LOCAL, producto.NOMBRE PRODUCTO, producto.DESCRIPCION DESCRIPCION,producto.PRECIO PRECIO")
    ...
    public function crear_pedido_enc($id_usuario, $id_local, $total)
    {
